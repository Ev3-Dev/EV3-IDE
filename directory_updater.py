...
class DirectoryUpdater:
    def __init__(self, root, ssh_container, editor, console, run_button, save_button, device_label, device_found_label, notification_manager, register_layout_callback):
        ...
        img = ctk.CTkImage(light_image=Image.open("images/home.png"), dark_image=Image.open("images/home.png"), size=(14, 14))
        ...
        img = ctk.CTkImage(light_image=Image.open("images/file.png"), dark_image=Image.open("images/file.png"), size=(14, 14))
        ...
        img = ctk.CTkImage(light_image=Image.open("images/directory.png"), dark_image=Image.open("images/directory.png"), size=(14, 14))
        ...
        img = ctk.CTkImage(light_image=Image.open("images/reload.png"), dark_image=Image.open("images/reload.png"), size=(14, 14))
